...
# --- Location forwarding (optional; only active when LOC_HOST is set) ---------
LOC_HOST = os.getenv("LOC_HOST")                       # unset => feature off
LOC_PORT = int(os.getenv("LOC_PORT", "0"))
LOC_FORMAT = os.getenv("LOC_FORMAT", "taip").lower()   # "taip" or "nmea"
LOC_PROTO = os.getenv("LOC_PROTO", "udp").lower()      # "udp" or "tcp"
LOC_VEHICLE_ID = os.getenv("LOC_VEHICLE_ID", "0000")   # TAIP ID (4 chars)
